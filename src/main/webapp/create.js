...
addFlashcard = () => {
    ...
    answer.value = '';
    var printout="";
    var updateDeck = JSON.parse(localStorage.getItem(deckname.value))
    console.log(updateDeck)
    for(var i =0;i<deck.length;i++)
    {
        printout+="<div class=\"flip-card\"><div class=\"flip-card-inner\"><div class=\"flip-card-front\"><p>"+deck[i].front+"</p></div><div class=\"flip-card-back\"><button onclick= \"deletecard('"+deckname.value+"','"+ i +"')\" class=\"ico-times\" role=\"img\" aria-label=\"Cancel\"></button><p>" +deck[i].back+"</p></div></div></div>"
    }
...
displayCreatedDeck = () =>{
        ...
        {
            printout+="<div class=\"flip-card\"><div class=\"flip-card-inner\"><div class=\"flip-card-front\"><p>"+obj[i].front+"</p></div><div class=\"flip-card-back\"><button onclick= \"deletecard('"+deckname.value+"','"+ i +"')\" class=\"ico-times\" role=\"img\" aria-label=\"Cancel\"></button><p>" +obj[i].back+"</p></div></div></div>"
        }
        document.getElementById("flashcards").innerHTML = printout;
}
...
deletecard= (deckName, cardIndex) =>
{
    ...
    for(var i =0;i<deck.length;i++)
    {
        printout+="<div class=\"flip-card\"><div class=\"flip-card-inner\"><div class=\"flip-card-front\"><p>"+deck[i].front+"</p></div><div class=\"flip-card-back\"><button onclick= \"deletecard('"+deckName+"','"+ i +"')\" class=\"ico-times\" role=\"img\" aria-label=\"Cancel\"></button><p>" +deck[i].back+"</p></div></div></div>"
    }
